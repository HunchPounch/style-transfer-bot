...
#### Перенос стиля с помощью CycleGAN:
  ...
  * Здесь принцип работы сложней, используется два генератора и дискриминаторы, работающие над переводами из домена в домен, а так же cycle consistency losses для сохранения структыры изображений. Благодаря данной структуры можно работать с непарными данными. Подробнее в [статье](https://arxiv.org/pdf/1703.10593)
